...
class spin(nn.Module):
    ...
    def __init__(self, planes, ratio=4):
        ...
        self.final = nn.Sequential(
            nn.Conv2d(planes * 2, planes, kernel_size=1, bias=False), BatchNorm2d(planes)
        )
    ...
    def forward(self, feat):
        ...
        return self.final(torch.cat((spatial_local_feat, g_out), 1))
